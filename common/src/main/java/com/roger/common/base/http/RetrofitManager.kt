package com.roger.common.base.http

import com.roger.common.base.AppLog
import com.roger.common.base.http.adapter.ErrorHandler
import com.roger.common.base.http.adapter.NetworkResponseAdapterFactory
import com.roger.common.base.http.converter.GsonConverterFactory
import com.roger.common.base.http.cookie.UserCookieJarImpl
import com.roger.common.base.http.interceptor.logInterceptor
import com.roger.common.di.ApplicationCoroutineScope
import com.roger.common.di.CoroutinesModule
import com.roger.common.services.BaseService
...
//            .cookieJar(cookieJarImpl)
    ...
    fun init(cookieJar: UserCookieJarImpl? = null) {
